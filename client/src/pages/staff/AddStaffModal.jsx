...
const AddStaffModal = ({
  ...
  const handleAddStaff = async (e) => {
    ...
    setError("");
    try {
      // Convert divisions arrays to individual assignments
      ...
      const res = await window.electronAPI.addStaff(payload);
      if (res.success) {
        setForm({
          name: "",
          contact: "",
                                  ...
                                  >
                                    {divisionOptions.map((div) => (
                                      <MenuItem key={div} value={div}>
                                        <Checkbox checked={(assignment.divisions || []).indexOf(div) > -1} />
