...
const AddTransportModal = ({ open, onClose, onSuccess, setError, setLoading }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const result = await window.electronAPI.addTransport(formData);
      ...
      if (result.success) {
        ...
        setError(result.error || "Failed to add transport entry");
      }
    } catch (err) {
      setError("Failed to add transport entry");
      ...
      <Slide in={open} direction="down">
        ...
        >
          ...
          <Box sx={{ p: 2, bgcolor: "#f8fafc" }}>
            ...
            <form id="transport-form" onSubmit={handleSubmit}>
