...
import EditAcademicYearModal from "../pages/academicYears/EditAcademicYearModal";
import DeleteAcademicYearModal from "../pages/academicYears/DeleteAcademicYearModal";
...
const AcademicYearsManagementModal = ({ open, onClose, onSuccess, setError, setLoading }) => {
  ...
  const fetchAcademicYears = async () => {
    ...
    try {
      const years = await window.electronAPI.listAcademicYears();
  ...
  const handleSetActive = async (yearId) => {
    setLoading(true);
    try {
      const result = await window.electronAPI.setActiveAcademicYear(yearId);
                  ...
                  <Card variant="outlined" className="h-full">
                    <CardContent>
                      ...
                      <Typography variant="body2" color="text.secondary" className="mb-1">
                        <strong>Start:</strong> {formatDate(year.start_date)}
                      </Typography>
                      <Typography variant="body2" color="text.secondary" className="mb-3">
                        <strong>End:</strong> {formatDate(year.end_date)}
                      </Typography>
